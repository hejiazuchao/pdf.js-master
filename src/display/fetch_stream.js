...
//}
  ...
  read() {
//  return this._headersCapability.promise.then(() => {console.log(2)
//    return this._reader.read().then(({ value, done, }) => {console.log(3)
//      if (done) {
...
//        });
//      }
//      let buffer = new Uint8Array(value).buffer;console.log(4)
//      return Promise.resolve({ value: buffer, done: false, });console.log(5)
//    });
//  });
  }
